(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  [2],
  {
    ...
    ECub: function (e, t, a) {
      ...
      var c = a('rePB'),
        ...
        g = function (e) {
          ...
          return s['createElement'](
            ...
            function (e) {
              var l = y('empty', a),
                o = 'undefined' !== typeof p ? p : e.description,
                i = 'string' === typeof o ? o : 'empty',
                f = null;
              return (
                (f =
                  'string' === typeof m
                    ? s['createElement']('img', { alt: i, src: m })
                    : m),
                s['createElement'](
                  'div',
                  Object(n['a'])(
                    {
                      className: r()(
                        l,
                        Object(c['a'])(
                          Object(c['a'])({}, ''.concat(l, '-normal'), m === d),
                          ''.concat(l, '-rtl'),
                          'rtl' === w,
                        ),
                        t,
                  ...
                  s['createElement'](
                    'div',
                    { className: ''.concat(l, '-image'), style: E },
                    f,
                  ),
                  o &&
                    s['createElement'](
      ...
      (g.PRESENTED_IMAGE_DEFAULT = u), (g.PRESENTED_IMAGE_SIMPLE = d);
      t['a'] = g;
    },
    R9oj: function (e, t, a) {
      'use strict';
